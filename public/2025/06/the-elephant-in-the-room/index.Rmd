...
```{r, out.width = "25%", fig.align='center', error = FALSE, warning=FALSE, echo=FALSE, fig.cap="Episode screenshots can tell a thousand words: The various incredulous contestant reactions of Rosie's 'We were the monsters weren't we?' statement.'"}
knitr::include_graphics(path = file.path(here::here(), "static", "img", "highlights", "monsters.png"))
```
