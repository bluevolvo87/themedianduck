# Code to produce the series ranking distribution
graph_title_label <- glue("Probability Distribution For Overall Series Rankings for Series {series_id}", 
                          series_id = series_id)
...
series_ranking_dist_plot <- ggplot(prop_series_win_df,
