...
> Using the latest data of Series 20 UK Taskmaster (up to Episode 2), generate ranking distributions for each contestant. Ranking distributions should be for within-episode and end-of-series placement, and the joint distribution for the full cast.
> 
> Bonus points for commenting on how how these distributions have changed since the last episode (Episode 1).

```{r, out.width = "50%", fig.cap = "Making my unique entrance for this particular task/post..."}
knitr::include_graphics("https://64.media.tumblr.com/3622f01f75bfc01016343bce1961e6ab/60e25bad6a104fab-10/s1280x1920/74b43e2ad82e43ff2b11377a4302318d39de5c4d.gifv")
```
...
```{r, out.width="50%", fig.cap = "INCOMING: Analysis and Insights!"}
knitr::include_graphics("https://64.media.tumblr.com/dfedf8367d2cd69252dbd650da8866dd/fa7597ef7025e20f-73/s1280x1920/7417e797b941d32b1841e3c946c2ce810ba17ebb.gifv")
```
...
```{r, out.width="40%", fig.cap = "Maisie wondering where all her 1st place probability mass went..."}
knitr::include_graphics("https://64.media.tumblr.com/34a4120316d51fd056e7306dafcd2490/fa7597ef7025e20f-92/s1280x1920/95e789dea9ddb8750564d826d9669c11050e95e0.gifv")
```
...
```{r, out.width="20%", fig.cap = "Yes Maisie, I am now the most likely to win the series..."}
knitr::include_graphics("https://64.media.tumblr.com/ee9519d9c2e5128f36e431d3007405e1/1a096307aecffc7d-96/s1280x1920/a55018d95b1eb98a2935c810c44af21e1a3a9318.gifv")
```
...
```{r,  out.width="40%", fig.cap = "Stripping Off Until the Next Post!" }
knitr::include_graphics("https://64.media.tumblr.com/9eb3bf6734c4a68bba41df66a363a188/7d508944206abc06-e9/s1280x1920/e2222c3680ba2e3b724ae62c01c05d624696b72c.gifv")
```
