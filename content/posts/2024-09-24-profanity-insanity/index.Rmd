...
::: {style="flex: 85%, align-items: center, justify-content: center; vertical-align: middle; align-self: center;"}
```{r, echo = FALSE}
blogdown::shortcode("callout", text = "Tick-tock it's hemorrhoid o'clock! The Geography teacher is the least foul mouth contestant; he is only expected to swear 0.1 times an episode! Good thing he is the assistant on Taskmaster Junior!")
```
:::
