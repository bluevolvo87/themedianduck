...
Contents of this preamble code can be found in this [git location](https://github.com/bluevolvo87/themedianduck/tree/main/static/code/R/preamble).
...
2.  Aggregating data to a series and speaker level.
    1.  Sum of the profanities uttered.[^1]
...
<span id="tab:foulest1"></span>Table 1: The Foulest Mouthed Contestants in UK Taskmaster
</caption>
...
<span id="tab:foulest-plot"></span>Table 2: Top 5 Foulest Mouthed Contestants in UK Taskmaster
</caption>
...
The profanity race (Table <a href="#tab:foulest-plot">2</a>) indicates that following top 5 positions in a profanity rate race:
...
There are no big surprises in these finishing positions although Asim Chaudhry being a close second is somewhat surprising since I don’t remember him being a particularly angry or foul mouthed incident with him[^3]. He’s a relatively mild mannered comedy actor who just wants everyone to know he is a vegan.
...
<span id="fig:foul-plot"></span>Figure 1: Foulest Contestant by Series
</p>

<img src="{{< blogdown/postref >}}index_files/figure-html/foul-plot-1.png" alt="Foulest Contestant by Series" width="75%" />

</div>

<div id="hello" class="greeting message" style="color: darkred; background-color: silver; border: 1px solid #dfe2e5;">

Some insights from Figure <a href="#fig:foul-plot">1</a>:
...
Some observations from Figure <a href="#fig:allpr-plot">2</a>:
...
<span id="fig:allpr-plot"></span>Figure 2: All Series Contestants Profanity Rates
</p>

<img src="{{< blogdown/postref >}}index_files/figure-html/allpr-plot-1.png" alt="All Series Contestants Profanity Rates" width="75%" />
...
<img src="https://taskmaster.info/images/people/0048_romesh_ranganathan.png" style="width:75.0%" />
...
<img src="https://taskmaster.info/images/people/0176_mike_wozniak_1.png" style="width:75.0%" />
...
[^3]: I’m looking at you Ed Gamble and Daisy May Cooper for these sorts of outbursts.
