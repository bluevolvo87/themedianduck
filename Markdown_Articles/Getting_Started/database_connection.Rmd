...
This article provides an overview of *Trabajo de las Mesas*, a Taskmaster database that will be central to performing a multitude of analysis and questions that we may want to answer regarding Taskmaster.
